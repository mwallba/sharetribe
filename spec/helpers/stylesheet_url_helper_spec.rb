...
RSpec.describe ApplicationHelper, type: :helper do
  ...
  describe "stylesheet url" do
    ...
    context "without user_assets_host" do
      before(:each) do
        @orig_assets_host = APP_CONFIG.user_assets_host
        APP_CONFIG.user_assets_host = nil
      end

      after(:each) do
        APP_CONFIG.user_assets_host = @orig_assets_host
      end
    ...
    context "with user_assets_host" do
      before(:each) do
        @cdn = "http://cdn.example.com"
        APP_CONFIG.user_assets_host = @cdn
      end
